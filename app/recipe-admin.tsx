...
import { getSampleRecipeImage } from '@/lib/recipes-samples';
...
const RecipeAdminScreen = () => {
  ...
  const openEditModal = (recipe: RecipeRecord) => {
    ...
    setEditImage(recipe.image_url ?? getSampleRecipeImage(recipe.title));
  ...
  const handleUpdateRecipe = async () => {
    ...
    try {
      ...
      const { data, error } = await updateRecipeAdmin(
        selectedRecipe.id,
        updatePayload,
    ...
    <>
      ...
      <ThemedBackground style={styles.background}>
        <SafeAreaView style={styles.safeArea}>
          ...
          <Header
            title='Rezept-Admin'
            subtitle='Server-Rezepte bearbeiten'
            showBackButton
              ...
              {!adminChecked || isLoading ? (
                ...
                >
                  <View style={styles.emptyStateBody}>
                    ...
                    <ThemedText style={styles.emptyStateText}>
                      Melde dich mit einem Admin-Account an, um Rezepte zu bearbeiten.
                    </ThemedText>
                  </View>
                </LiquidGlassCard>
              ) : recipes.length === 0 ? (
                ...
                >
                  <View style={styles.emptyStateBody}>
                    ...
                    <ThemedText style={styles.emptyStateText}>
                      Erstelle neue Rezepte im Generator.
                    </ThemedText>
                  </View>
                </LiquidGlassCard>
              ) : (
...
export default RecipeAdminScreen;
