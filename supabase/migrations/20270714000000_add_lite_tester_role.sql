-- ============================================================
-- Paywall-Sonderzugänge: neue Rolle 'lite_tester'.
--
-- Lite-Tester bekommen ohne Abo den Lite-Tier (Basis-Tracker,
-- 7-Tage-Verlauf, keine Partner-/Planer-/KI-Features) — zum
-- Testen der Lite-Grenzen aus Nutzersicht.
