...
const de = {
  ...
  'card.shopping.title': 'Einkauf & Vorräte', 'card.shopping.description': 'Liste, Bestand, Scanner',
  ...
  'timer.sleep.label': 'Schlaftracker', 'timer.sleep.title': 'Schlaf läuft gerade', 'timer.sleep.hint': 'Tippe, um direkt in den Schlaftracker zu springen',
  ...
  'premium.advisor': 'Lottis Fürsorge', 'premium.advisorDescription': 'Persönliche Hinweise aus Schlaf, Wetter & Ernährung', 'premium.voice': 'Per Sprache eintragen', 'premium.voiceDescription': 'Schlaf, Füttern & Windeln einsprechen', 'premium.askLotti': 'Frag Lotti', 'premium.askLottiDescription': 'Alltagstipps – mit euren Daten, wenn passend',
...
const en: Catalog = {
  ...
  'card.recipes.title': 'BLW recipes', 'card.recipes.description': 'Discover recipes', 'card.shopping.title': 'Shopping & supplies', 'card.shopping.description': 'List, stock, scanner', 'card.baby.title': 'My baby', 'card.baby.description': 'All information & development', 'card.planner.title': 'Planner', 'card.planner.description': 'Daily plan & to-dos', 'card.daily.title': 'Our day', 'card.daily.description': 'Manage daily activities', 'card.selfcare.title': 'Mom self-care', 'card.selfcare.description': 'Take some time for yourself', 'card.weather.title': 'Baby weather', 'card.weather.description': 'Current weather information', 'card.shop.title': 'Lotti Baby Shop', 'card.shop.description': 'Shop iron-on prints', 'card.weight.title': 'Weight chart', 'card.weight.description': 'Track weight', 'card.size.title': 'Growth chart', 'card.size.description': 'Track baby’s height', 'card.teeth.title': 'Tooth tracker', 'card.teeth.description': 'First little teeth', 'card.milestones.title': 'Milestones', 'card.milestones.description': 'Capture first moments',
  'timer.sleep.label': 'Sleep tracker', 'timer.sleep.title': 'Sleep is being tracked', 'timer.sleep.hint': 'Tap to jump straight to the sleep tracker', 'timer.breast': 'Breastfeeding in progress', 'timer.bottle': 'Bottle feeding in progress', 'timer.solids': 'Solid feeding in progress', 'timer.pump': 'Pumping in progress', 'timer.water': 'Water intake in progress', 'timer.daily.label': 'Our day', 'timer.daily.hint': 'Tap to continue in “Our day”', 'timer.since': 'since {{time}}',
  ...
  'premium.advisor': 'Lotti’s care', 'premium.advisorDescription': 'Personal insights from sleep, weather & nutrition', 'premium.voice': 'Log by voice', 'premium.voiceDescription': 'Record sleep, feeding & diapers by voice', 'premium.askLotti': 'Ask Lotti', 'premium.askLottiDescription': 'Everyday guidance, personalized when relevant',
...
const es: Catalog = {
  ...
  'premium.advisor': 'Los cuidados de Lotti', 'premium.advisorDescription': 'Consejos personales sobre sueño, tiempo y nutrición', 'premium.voice': 'Registrar por voz', 'premium.voiceDescription': 'Registra sueño, alimentación y pañales con tu voz', 'premium.askLotti': 'Pregunta a Lotti', 'premium.askLottiDescription': 'Orientación diaria, personalizada si es relevante',
