...
const de = {
  ...
  'premium.advisor': 'Lottis Fürsorge', 'premium.advisorDescription': 'Persönliche Hinweise aus Schlaf, Wetter & Ernährung', 'premium.voice': 'Per Sprache eintragen', 'premium.voiceDescription': 'Schlaf, Füttern & Windeln einsprechen',
...
const en: Catalog = {
  ...
  'premium.advisor': 'Lotti’s care', 'premium.advisorDescription': 'Personal insights from sleep, weather & nutrition', 'premium.voice': 'Log by voice', 'premium.voiceDescription': 'Record sleep, feeding & diapers by voice',
...
const es: Catalog = {
  ...
  'premium.advisor': 'Los cuidados de Lotti', 'premium.advisorDescription': 'Consejos personales sobre sueño, tiempo y nutrición', 'premium.voice': 'Registrar por voz', 'premium.voiceDescription': 'Registra sueño, alimentación y pañales con tu voz',
