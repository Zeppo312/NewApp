...
const translations = {
  de: {
    ...
    introText: 'Barcode einmal scannen und an der Kasse jederzeit wieder öffnen. Mit deinem verknüpften Partner geteilt.',
  ...
  en: {
    ...
    introText: 'Scan a barcode once and open it anytime at checkout. Shared with your linked partner.',
  ...
  es: {
    ...
    introText: 'Escanea el código una vez y ábrelo cuando quieras en caja. Se comparte con tu pareja vinculada.',
