...
const localizedDefaults: Record<Exclude<AppLocale, 'de'>, PaywallPlansContent> = {
  en: {
    ...
    comparisonRows: [
      ...
      { label: 'Complete sleep & daily history (Lite: 7 days)', lite: false, standard: true, premium: true },
    ...
    tiers: {
      premium: { visible: true, name: 'Lotti Premium', tagline: "Everything in Standard plus the briefing & Lotti's AI features", ctaLabel: 'Start Premium', bullets: ['Everything in Lotti Standard', '✨ Personal pregnancy briefing', "✨ Voice logging & Lotti's Care", '✨ Ask Lotti using relevant data from your routine'] },
      standard: { visible: true, name: 'Lotti Standard', tagline: 'Complete support for your family', ctaLabel: 'Start Standard', bullets: ['Everything in Lite with complete sleep & daily history', 'Partner connection, planner & shared calendar', 'Shopping lists, stock, alerts & loyalty cards', 'Weekly moments, recipes, insights & data export'] },
  ...
  es: {
    ...
    comparisonRows: [
      ...
      { label: 'Historial completo de sueño y del día (Lite: 7 días)', lite: false, standard: true, premium: true },
    ...
    tiers: {
      premium: { visible: true, name: 'Lotti Premium', tagline: 'Todo lo de Standard más el resumen y las funciones de IA de Lotti', ctaLabel: 'Empezar Premium', bullets: ['Todo lo de Lotti Standard', '✨ Resumen personal del embarazo', '✨ Registro por voz y Cuidados de Lotti', '✨ Pregunta a Lotti con datos relevantes de vuestra rutina'] },
      standard: { visible: true, name: 'Lotti Standard', tagline: 'Acompañamiento completo para vuestra familia', ctaLabel: 'Empezar Standard', bullets: ['Todo lo de Lite con historial completo de sueño y del día', 'Conexión de pareja, agenda y calendario compartido', 'Listas, existencias, avisos y tarjetas de fidelidad', 'Momentos, recetas, análisis y exportación de datos'] },
