// Lottis Fürsorge — Regel-Engine für die Schwangerschaft (kanonische Fassung).
//
// Bewusst ohne Imports. Metro blockt den Ordner `supabase/`, Deno-Functions
// dürfen nicht aus `lib/` importieren – deshalb liegt eine 1:1-Kopie unter
// supabase/functions/advisor-generate/pregnancyRules.ts. Beide Dateien müssen
